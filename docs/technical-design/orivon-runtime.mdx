...
More specifically, the [Modules System](/docs/implementations/modules-system) engine

*orivon-runtime* as a package is supposed to be integrated into Clients programs that will use it based on their needs

If fully satisfies the Module System cited benefits, such as:
- **Cross compatibility** *of WASM modules*, across any type of Orivon implementation (HTTP clients, Curl, Browsers, embedded etc..)
- **Run everything on Web3**
- **Programming language independence**
- **High performance**
- **Made to be run on-fly**
- **Great code maintenance and scalability**
- **Manageable security model**

Clients has the full power over *orivon-runtime*, so, they will be the ones responsible of following the corrects security guidelines based on the official Orivon best practice instructions
...
Then [***standards***](/docs/technical-design/standards) are the key to make modules work well all together in a safe manner
