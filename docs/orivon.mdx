...
More implementation details of specific components are available in [**Implementations**](/docs/implementations/dashboard-app).  
...
- **Dashboard:** The application used to display the dashboard in new browser tabs – [*Orivon Dashboard*](/docs/implementations/dashboard-app)
- **DNS Resolution** – [*details*](/docs/implementations/dns-resolution)
- **Data Gathering** (e.g., IPFS, Arweave, Blockchain, etc.) – [*details*](/docs/implementations/data-gathering)
...
This means that `bitcoind` from [bitcoin-core](https://github.com/bitcoin/bitcoin) could already run as a site on Orivon. It would only require writing a web frontend to interact with it.

### Other Features

#### Web3 Applications Store

Orivon will include a store specifically for [Applications](#applications--also-called-special-extensions-) that expand the browser’s capabilities.
...
Web3 search engines will be integrated, possibly combining Web2 and Web3 indexing while prioritizing results based on [Web3 Score](/docs/implementations/web3-score).
