...
Orivon Browser will feature on the main new tab page the [Orivon Dashboard](/docs/implementations/dashboard-app) App (changeable trough the [Application System](#application-system-and-advanced-wasm))
